...
We will only be looking at a few ideas in statistics that we need for the 
upcoming modules. Namely
...
`d` as encoding data from an experiment. In the following sense
...
bias we introduce between the groups.
...
statistics can tell us how much the data points vary from each other. We 
turn to this next.
...
You should be able to answer these questions below based on the code above.
...
There are many ways to visualize any set of data. The basic graphs such as
...
word, it divides the data into ranges called 'bins' and count how many  data 
...
Looking at the mean, variance, and plots we made, you can easily tell that 
