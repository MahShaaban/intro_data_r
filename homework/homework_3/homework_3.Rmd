...
Now that you've learned to use `pcr` functions to analyze, visualize and test
...
code are very similar to what you have seen in previous sections with one 
wrinkle. Read the description bellow and see if you can spot the difference. 
Once you do that, you will need to find a way to modify the code to accommodate
this difference and complete the analysis properly.
...
The following is just an R prompt for you to work in.
...
Now based on your results try and answer the following questions
