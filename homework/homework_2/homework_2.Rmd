...
The dataset `d3` consist of two variables: `V1` and `V3`. Looking at the plot 
below, we can tell that the two variables are correlated, but it is hard to tell
by how much and whether the correlation is significant.
...
Here is what you need to do to answer these questions that follow
